...
import { addVehicle } from "../../../service/vehcile.service";
const VehicleCreate = () => {
    const [vehicleName, vehicleNameupdate] = useState('');
    const [type, typeupdate] = useState('');
    const [vehicleNo, vehicleNoUpdate] = useState(0);
    const [rating, ratingupdate] = useState(0);
    const [price, priceupdate] = useState(0);
    const [capacity, capacityupdate] = useState(0);
    ...
    const [ownerid, owneridupdate] = useState(user.ownerId);

    const handlesubmit = (e) => {
        e.preventDefault();
        var vehicleImg1 ="../Assets/"+ vehicleImg.substring(12 , vehicleImg.length);
        const vehicledata = { "vehicleName":vehicleName, "vehicleNo":vehicleNo, "type":type, "rating":rating, "price":price, "capacity":capacity, "ownerId":user.ownerId ,image:vehicleImg1};
    ...
    return (
        <>
        <OwnerNavbar/>
    <div className="user-div vehiclecreate-div"> 
        <div className="row">
            <div className="offset-lg-3 col-lg-6">
                <form className="container" onSubmit={handlesubmit} style={{marginTop:10}}>
                    <div className="card" style={{ "textAlign": "left",width:400,margin:'auto'}}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-footer">
                                <button className="btn btn-success" type="submit">Add Vehicle</button>
                                <Link to="/owner/vehiclelist" className="btn btn-primary">See Vehicle List</Link>
                            </div>
